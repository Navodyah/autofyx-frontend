...
import { Plus, Pencil, Trash2, Search, Car, Calendar } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-2xl shadow-xl p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold mt-1">{filteredModels.length}</p>
              </div>
          ...
          <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl shadow-xl p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-purple-100 text-sm">Active Years</p>
                <p className="text-3xl font-bold mt-1">
                  {models.length > 0 ? Math.max(...models.map(m => m.end_year)) : 0}
                </p>
              </div>
