...
import { Plus, Edit, Trash2, Search, Car, BarChart3, Package } from 'lucide-react';
...
export default function VehicleClassesListPage() {
  const [data, setData] = useState<VehicleClass[]>([]);
  ...
  const handleDelete = async (id: number) => {
    if (confirm('Are you sure you want to delete this vehicle class?')) {
      try {
        // DELETE request with axios
        await axios.delete(`http://127.0.0.1:8000/vehicle_classes/${id}`);
        setData(data.filter((item) => item.class_id !== id));
        alert('Vehicle Class deleted successfully!');
      } catch (error) {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-500 mt-2">Manage vehicle classification categories</p>
            </div>
            <Link href="/admin_dashboard/catalog/vehicles_class/new">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 mb-8">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search vehicle classes by name..."
                  ...
                  {filteredData.length === 0 ? (
                    <tr>
                      <td colSpan={3} className="px-6 py-12 text-center text-gray-500">
                        ...
                        <p className="text-lg font-semibold">No vehicle classes found</p>
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-center">
                          <div className="flex items-center justify-center gap-2">
                            <Link href={`/admin_dashboard/catalog/vehicles_class/${item.class_id}`}>
